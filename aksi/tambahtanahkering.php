...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO tb_tanah_kering ( id,
                                nomer_iuran,
                                no_persil,
                                kelas_desa,
                                luas_tanah_ha,
    ...
    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Insert data berhasil! Klik ok untuk melanjutkan');location.replace('../datatanahpemilik.php?no_iuran={$noiuran}')</script>";
    } else {
