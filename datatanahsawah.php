                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Tanah Sawah <a href="" class="badge badge-primary text-warning badge-xs" data-toggle="modal" data-target="#tambahModal"><i class="fa fa-plus"></i> Tambah Data Tanah Sawah</a></h6>
                        </div>
              ...
              <div class="table-responsive" style="font-size:13px">
                <table class="table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $no = 1;
                    include 'koneksi.php';
                    $query = mysqli_query($conn, "SELECT * FROM tb_tanah_sawah a JOIN tb_pemilik_tanah b ON a.nomer_iuran = b.nomer_iuran");
            ...
            <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="nomer_iuran" id="nomer_iuran" class="form-control" required>
                                    <?php
                                    $query = "SELECT * FROM tb_pemilik_tanah ORDER BY nomer_iuran";
